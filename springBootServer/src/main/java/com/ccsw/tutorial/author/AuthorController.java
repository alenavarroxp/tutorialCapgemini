...
public class AuthorController {
    ...
    /**
     * Busqueda por autor especifico en listado simple
     * 
     * @return Author
     */

    @Operation(summary = "Find", description = "Method that return a specific Author")
    @RequestMapping(path = "/{id}", method = RequestMethod.GET)
    public AuthorDto findById(@PathVariable("id") Long id) throws Exception {
        Optional<Author> author = this.authorService.findOne(id);
